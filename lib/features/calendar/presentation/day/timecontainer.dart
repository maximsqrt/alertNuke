          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
                ...
                if (iconIndex == index) {
                  return Row(
                        ...
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Icon(appointment.iconWithName.icon, color: Colors.white,),
                            SizedBox(width: 2),
                            Text(
                                "${appointment.iconWithName.name} - ${appointment.iconWithName.iconDescription}", style: TextStyle(color: Colors.white),),
                          ],
                        )
                      ]);
              ...
              return GestureDetector(
                onTap: () =>  _showIconSelectionDialog(context, hour, minute, index),
                child:Padding(
                padding: const EdgeInsets.symmetric(
